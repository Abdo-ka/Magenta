...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i494.Client>(() => appModule.client);
    gh.factory<_i192.TokenRepository>(() => _i192.TokenRepositoryImp());
    gh.factory<_i959.AuthRepositories>(
        () => _i959.AuthRepositories(gh<_i494.Client>()));
    gh.factory<_i393.FavouriteRepositories>(
        () => _i393.FavouriteRepositories(gh<_i494.Client>()));
    gh.factory<_i375.CartRepositories>(
        () => _i375.CartRepositories(gh<_i494.Client>()));
    gh.factory<_i491.HomeRepositories>(
        () => _i491.HomeRepositories(gh<_i494.Client>()));
    gh.factory<_i380.NotificationRepositories>(
        () => _i380.NotificationRepositories(gh<_i494.Client>()));
