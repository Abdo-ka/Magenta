...
class _AppSwitchState extends State<AppSwitch> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _animationController = AnimationController(vsync: this, duration: const Duration(milliseconds: 70));
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: !widget.value ? const Color(0xffF2F4F7) : const Color(0xffFB5607),
            ),
            child: Padding(
  ...
  void toggle() {
    ...
    widget.value == false ? widget.onChanged?.call(true) : widget.onChanged?.call(false);
  }
}
