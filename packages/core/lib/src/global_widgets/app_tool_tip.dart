...
class AppTooltip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return JustTheTooltip(
      ...
      content: Padding(
        padding: message != null ? REdgeInsets.all(16.0) : REdgeInsets.symmetric(vertical: 8, horizontal: 12),
        child: Column(
          ...
          children: [
            AppText(
              ...
              style: preferredMediumTitle ? context.textTheme.xs.medium : context.textTheme.xs.semiBold,
            ),
            ...
            if (message != null)
              AppText(
                ...
                style: context.textTheme.xs.medium,
              ),
          ],
        ),
      ),
